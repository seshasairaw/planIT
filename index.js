...
app.get("/", isloggedinfor, function (req, res, next) {
  req.user.populate('foodexpense').populate('entertainmentexpense').populate('householdexpense').populate('miscelleniousexpense').populate('shoppingexpense').populate('transportexpense');
...
app.post("/signup", function (req, res) {
  if((req.body.username.length<=2) || (req.body.username.length>20)){
    ...
    var nameofuser = 
    Users = new User({ email: req.body.email, username: req.body.username, name: req.body.name, phoneno: req.body.phoneno });
          ...
          if (!user) {
            ...
            req.login(user, function (err) {
              if (err) {
                ...
                User.findById(user._id).populate('foodexpense').populate('entertainmentexpense').populate('householdexpense').populate('miscelleniousexpense').populate('shoppingexpense').populate('transportexpense').exec((err, user) => {
                  if (err)
                    console.log(err)
                  else {
                    // console.log(user);
...
app.get("/signin", isloggedin, function (req, res, next) {
  User.findById(req.user._id).populate('foodexpense').populate('entertainmentexpense').populate('householdexpense').populate('miscelleniousexpense').populate('shoppingexpense').populate('transportexpense').exec((err, user) => {
    if (err)
      console.log(err)
    else {
      // console.log(user);
...
app.get('/food/add', isloggedin, function (req, res, next) {
  User.findById(req.user._id).populate('foodexpense').exec((err, user) => {
    if (err)
      console.log(err)
    else {
      console.log(user);
...
app.get('/entertainment/add', isloggedin, function (req, res, next) {
  User.findById(req.user._id).populate('entertainmentexpense').exec((err, user) => {
    if (err)
      console.log(err)
    else {
      console.log(user);
...
app.get('/transport/add', isloggedin, function (req, res, next) {
  User.findById(req.user._id).populate('transportexpense').exec((err, user) => {
    if (err)
      console.log(err)
    else {
      console.log(user);
...
app.get('/household/add', isloggedin, function (req, res, next) {
  User.findById(req.user._id).populate('householdexpense').exec((err, user) => {
    if (err)
      console.log(err)
    else {
      console.log(user);
...
app.get('/shopping/add', isloggedin, function (req, res, next) {
  User.findById(req.user._id).populate('shoppingexpense').exec((err, user) => {
    if (err)
      console.log(err)
    else {
      console.log(user);
...
app.get('/miscellenious/add', isloggedin, function (req, res, next) {
  User.findById(req.user._id).populate('miscelleniousexpense').exec((err, user) => {
    if (err)
      console.log(err)
    else {
      console.log(user);
